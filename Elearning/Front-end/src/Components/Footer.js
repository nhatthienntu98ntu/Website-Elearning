...
<div className="footer">
    <div className="container">
        <div className="row">
            <div className="col-3">
                <h4 className="title-heading"><i className="fa fa-home" /> Thông tin Acexis</h4>
                <a href="#">Giới thiệu</a>
    ...
    <div className="top float-right">TOP</div>
</div>

<p className="endfooter text-center">Designed by <span className="name">Liễu Triệu Thuận</span> &amp; <span className="name">Nguyễn Nhật Thiên</span></p>
