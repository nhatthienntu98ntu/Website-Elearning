        ...
        return (
            ...
            <div className="header wow bounceInLeft" data-wow-duration="1s">
                ...
                <div className="contact-header float-left">
                    ...
                    <i className="fa fa-envelope-o"> <span className="gmail">ThienThuan1998@gmail.com</span></i>
                ...
                <div className="registration float-right">
                    <Link to="/login" className="signIn" data-text="SignIn">SignIn</Link>
                    {/* <a href="#" className="singOut" data-text="SignUp">SignUp</a> */}
                </div>
                </div>
            </div>
            //  <!-- End Header -->
