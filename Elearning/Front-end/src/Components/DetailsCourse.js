...
import {CREATE_USER} from './data.app/userCreate'
...
<div>
    ...
    <Menu />
    <Slider />
    <div className="title text-center wow bounceInUp"  data-wow-duration="1.2s">     
        ...
        <div className="row">
            ...
            <div className="col-6 introduce">
                ...
                <p className="heading-course">Học đến khi thành thạo thì thôi <br/>
                    ...
                    Lưu ý: Hình thức học của Fedu là học ONLINE, chúng tôi không mở lớp dạy trực triếp hoặc offline. Học viên vui lòng cân nhắc trước khi đăng ký. <br/>
